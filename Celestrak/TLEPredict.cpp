...
static const double WW = 2.0 * M_PI / YT; // Earth's rotation rate, radians/whole day
static const double WE = 2.0 * M_PI + WW; // Earth's rotation rate, radians/day
...
int main()
{
    ...
    while (hour1 < 24){
        while (minute1 < 60){
            while (second1 < 60){
                DateTime MyTime1(year, month, day, hour1, minute1, second1); // Set start time for the prediction
